<script lang="ts">
  ...
  let input = $state(
    "https://docs.google.com/spreadsheets/d/1a2b3c4d5e6f7g8h9i0j_ABCDEFG_hijklmnop/edit#gid=0",
  );
...
<section class="max-w-3xl mx-auto px-6 py-12">
  ...
  <p style="color:rgba(255,255,255,0.4);margin-top:8px;">
    Extract the spreadsheet ID (and tab GID) from any Google Sheets URL.
  </p>
  ...
  <div class="grid sm:grid-cols-2 gap-4 mt-6">
    <div class="card p-4">
      <div
        style="font-size:12px;color:rgba(255,255,255,0.4);text-transform:uppercase;"
      >
        Spreadsheet ID
      </div>
