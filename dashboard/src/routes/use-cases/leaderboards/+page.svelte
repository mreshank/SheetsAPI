...
await fetch('https://sheetsapi.gkit.mreshank.com/api/spreadsheets/YOUR_KEY/scores', {
  method: 'POST',
...
// Top 10 leaderboard
const r = await fetch(
  'https://sheetsapi.gkit.mreshank.com/api/spreadsheets/YOUR_KEY/scores?sort=-score&limit=10'
);`;
