...
<article class="max-w-3xl mx-auto px-6 py-16 prose">
  ...
  <p>SheetsAPI provides a REST API layer over your Google Sheets. Core features are offered free of charge; paid plans may be introduced later.</p>

  <h2 class="text-2xl font-semibold mt-10">3. Your account</h2>
  <p>You must have a Google account. You are responsible for activity on your account and for the security of your API keys. Revoke access any time from the dashboard or from Google.</p>
  ...
  <p>Our aggregate liability for any claim related to the service is limited to the fees you paid us in the 12 months preceding the claim (or US$100 if you use the free tier).</p>

  <h2 class="text-2xl font-semibold mt-10">9. Termination</h2>
  <p>You may terminate at any time by signing out; we may terminate for material breach of these terms or the AUP, with notice where practicable.</p>

  <h2 class="text-2xl font-semibold mt-10">10. Changes</h2>
  <p>Material changes are communicated by email. Continued use after the effective date constitutes acceptance.</p>
