...
<section class="max-w-5xl mx-auto px-6 py-12">
  ...
  <p style="color:rgba(255,255,255,0.4);margin-top:8px;">
    Paste JSON, format it, or minify it. All client-side - your data never
    leaves the browser.
  </p>
  ...
  <div class="grid md:grid-cols-2 gap-4 mt-8">
    ...
    <div>
      ...
      {:else}
        <pre
          class="h-96 mt-1 p-3 bg-[rgba(255,255,255,0.04)] text-[rgba(255,255,255,0.7)] rounded-lg overflow-auto text-xs">{output}</pre>
      {/if}
    </div>
  </div>
</section>
